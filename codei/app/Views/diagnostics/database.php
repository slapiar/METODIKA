...
<form method="post" action="<?= base_url('diagnostics/database/test-api') ?>">
    <button type="submit">Test API /api/gate/sessions</button>
</form>
...
const csrfName=<?= json_encode(csrf_token(), JSON_UNESCAPED_SLASHES) ?>,startUrl=<?= json_encode(site_url('diagnostics/concurrency/start'), JSON_UNESCAPED_SLASHES) ?>,hitAUrl=<?= json_encode(site_url('diagnostics/concurrency/hit/a'), JSON_UNESCAPED_SLASHES) ?>,hitBUrl=<?= json_encode(site_url('diagnostics/concurrency/hit/b'), JSON_UNESCAPED_SLASHES) ?>,resultBaseUrl=<?= json_encode(site_url('diagnostics/concurrency/result'), JSON_UNESCAPED_SLASHES) ?>;let csrfHash=<?= json_encode(csrf_hash(), JSON_UNESCAPED_SLASHES) ?>;
