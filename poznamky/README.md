# Register stavov dokumentov v `poznamky/`

## Účel

Tento súbor je záväzným registrom stavu každého dokumentu uloženého v adresári `poznamky/`.
...
Pri vytvorení, premenovaní, presunutí alebo významovej zmene dokumentu v `poznamky/` sa musí v tom istom pracovnom kroku aktualizovať aj tento register a `CHANGELOG.md`.
