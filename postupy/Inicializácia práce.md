...
Inicializačný záznam musí byť uvedený v pracovnom zázname alebo v `CHANGELOG.md` ako dôkaz otvorenia brány. Inicializačný záznam musí byť na konci opatrený dôkazom o dôkladnom prečítaní a naplnení všetkých pokynov tohto súboru, nasledovne: #ID (-číslo medodického pokynu v tomto súbore), R (- prečítané) =[1/0], W (-vykonané/zapísané) =[1/0]. 
