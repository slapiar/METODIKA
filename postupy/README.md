...
|---|---|---|
| `WORK/INI/2026-07-27_11-46_INI_Krok_12_Jeden_release_a_uplny_audit_balika.md` | PRACOVNÝ | Samostatná deväťbodová inicializačná brána Kroku 12. Všetky body sú doložené, `GATE=OPEN`; checkpointy potvrdzujú Fázy 12.A–12.E ako splnené. Rollback `1.1.9` je dostupný a zdrojovo zhodný, historický `1.1.15` zostal nepoužitý a nezmenený a dôkazová väzba release `1.1.16` je úplná. Po vzdialenom read-backu nasleduje Fáza 12.F. |
| `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md` | PRACOVNÝ — **ZÁVÄZNÝ PRE KROK 12** | Podrobný vykonávací plán Fáz 12.A–12.F. Fázy 12.A–12.E sú splnené; release `1.1.16` vznikol raz, auditný run `30260322371` aj opätovný audit po prenose skončili `PASS` a prednasadzovací rollback release dávky je doložený. Po vzdialenom read-backu checkpointu 12.E bezprostredne nasleduje Fáza 12.F. |
| `WORK/2026-07-27_11-53_Inicializacia_analyza_a_plan_Kroku_12.md` | PRACOVNÝ | Záznam inicializácie, analýzy, vytvorenia záväzného plánu a vykonania Fáz 12.A–12.E. Dokladá úplnú väzbu validovaného stromu na release `1.1.16`, rollbackový balík `1.1.9`, nepoužitý historický balík `1.1.15` a doložený rollback release dávky. Produkcia zostala bez zásahu; nasleduje Fáza 12.F. |
...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 11 a Fázy 12.A–12.E sú `SPLNENÉ`; release `1.1.16` je úplne auditovaný, rollback a dôkazová väzba sú doložené. Po read-backu checkpointu 12.E nasleduje Fáza 12.F; nasadenie a Krok 13 zostávajú zatvorené. |
