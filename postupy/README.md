...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 12 sú `SPLNENÉ`; release `1.1.16`, úplný audit, rollback aj konečný read-back sú doložené. Krok 13 ešte nie je otvorený a môže sa začať iba vlastným INI a GATE. |
