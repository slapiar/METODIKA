...
|---|---|---|
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny záväzný plán pokračovania Krokov 11 až 15. Zachováva Kroky 1 až 10 ako `SPLNENÉ`; Krok 11 má `GATE=CLOSED` a pokračuje iba v pôvodnom INI. Najprv vyžaduje obnovu skutočného stavu, klasifikáciu 71 commitov a návrh celej testovacej sústavy naraz; až potom jednu implementačnú dávku, úplnú Validáciu, jeden release, jedno nasadenie, jeden produkčný priechod a cleanup. Vytvorený 2026-07-26. |
...
| `WORK/INI/2026-07-25_09-29_INI_Krok_11_Uplna_lokalna_a_integracna_validacia.md` | PRACOVNÝ | Jediný autoritatívny inicializačný a pokračovací záznam Kroku 11. Po neskorších zmenách vykonateľného `main` má aktuálne `GATE=CLOSED`. Nevytvára sa nový INI ani nový environmentálny test; najbližšie sa v ňom vykoná iba Fáza 11.A podľa plánu z 2026-07-26. |
