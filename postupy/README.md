...
|---|---|---|
| `WORK/INI/2026-07-27_11-46_INI_Krok_12_Jeden_release_a_uplny_audit_balika.md` | PRACOVNÝ | Samostatná deväťbodová inicializačná brána Kroku 12. Všetky body sú doložené, `GATE=OPEN`; checkpointy potvrdzujú `FÁZA_12_A=SPLNENÁ` a `FÁZA_12_B=SPLNENÁ`. Run `30258778406` doložil presný checkout, PHP 8.4.23, Composer 2.10.2, povinné nástroje, zhodný `/codei` a čistý strom. Ďalej je povolená iba Fáza 12.C po vzdialenom read-backu checkpointu. |
| `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md` | PRACOVNÝ — **ZÁVÄZNÝ PRE KROK 12** | Podrobný vykonávací plán Fáz 12.A–12.F. Fázy 12.A a 12.B sú splnené: technický strom je zmrazený na `4ec1d840...` a izolované release prostredie je prakticky doložené úspešným runom `30258778406`. Aktívna je Fáza 12.C; release `1.1.16` ani nový ZIP ešte nevznikli. |
| `WORK/2026-07-27_11-53_Inicializacia_analyza_a_plan_Kroku_12.md` | PRACOVNÝ | Záznam inicializácie, analýzy, vytvorenia záväzného plánu a vykonania Fáz 12.A–12.B. Dokladá stabilný zdroj, zdrojovo zhodný rollback `1.1.9`, presný checkout `97800c0...`, pripravený runtime a zachovanie `RELEASE_VERSION=1.1.15`, ZIP-ov aj produkcie bez zmeny. |
