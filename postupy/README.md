...
|---|---|---|
| `WORK/INI/2026-07-27_11-46_INI_Krok_12_Jeden_release_a_uplny_audit_balika.md` | PRACOVNÝ | Samostatná deväťbodová inicializačná brána Kroku 12. Všetky body sú doložené, `GATE=OPEN`; checkpoint potvrdzuje `FÁZA_12_A=SPLNENÁ`, nezmenený `/codei`, verziu `1.1.15`, existujúce ZIP-y a produkciu. Ďalej je povolená iba Fáza 12.B po vzdialenom read-backu checkpointu. |
| `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md` | PRACOVNÝ — **ZÁVÄZNÝ PRE KROK 12** | Podrobný vykonávací plán Fáz 12.A–12.F. Fáza 12.A je splnená: technický strom je zmrazený na `4ec1d840...`, rollback `1.1.9` je zdrojovo zhodný a historický ZIP `1.1.15` je uzavretý ako neaktívna základňa. Aktívna je príprava Fázy 12.B; release `1.1.16` ani nový ZIP ešte nevznikli. |
| `WORK/2026-07-27_11-53_Inicializacia_analyza_a_plan_Kroku_12.md` | PRACOVNÝ | Záznam inicializácie, analýzy, vytvorenia záväzného plánu a vykonania Fázy 12.A. Dokladá stabilný vzdialený `main`, zhodu `/codei`, byte-identický a zdrojovo zhodný rollback `1.1.9` a zachovanie `RELEASE_VERSION=1.1.15`, ZIP-ov aj produkcie bez zmeny. |
...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 11 a Fáza 12.A sú `SPLNENÉ`; Krok 12 má `GATE=OPEN` a pokračuje iba Fázou 12.B po vzdialenom read-backu checkpointu podľa podrobného plánu `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md`. |
