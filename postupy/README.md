...
| `2026-07-22_APLIKACNY-KONTRAKT-ODVODZOVANIA-OTAZOK.md` | PRACOVNÝ | Prvý aplikačný kontrakt odvodzovania otázok. Určuje topológiu odozvy `PARTIAL_RUN_WITH_ATOMIC_GATE`: spoločné vstupy tvoria atómovú bránu, nezávislé kandidátske vetvy sa spracúvajú čiastočne a každý výsledok sa vracia zdroju s auditnou stopou. Čaká na Validáciu pred technickým návrhom služby. |
