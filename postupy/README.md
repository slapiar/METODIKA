...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 12 sú `SPLNENÉ`; Krok 13 je uzavretý riadeným STOP po produkčnom nasadení `1.1.16` a priamej oprave CSS regresie. Opravný release `1.1.17` je v repozitári; jeho nasadenie nie je potvrdené. Ďalším povoleným úkonom je Krok 14 s vlastným INI a GATE. |
