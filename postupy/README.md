...
|---|---|---|
| `WORK/INI/2026-07-27_11-46_INI_Krok_12_Jeden_release_a_uplny_audit_balika.md` | PRACOVNÝ | Samostatná deväťbodová inicializačná brána Kroku 12. Všetky body sú doložené, `GATE=OPEN`; rozsahom je jeden release `1.1.16` a úplný audit balíka bez nasadenia alebo zásahu do produkcie. |
| `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md` | PRACOVNÝ — **ZÁVÄZNÝ PRE KROK 12** | Podrobný vykonávací plán Fáz 12.A–12.F. Oddeľuje zdrojovo preukázaný release `1.1.9` od iba produkčne pozorovanej verzie `1.1.15`, eviduje nezhodu historického ZIP-u `1.1.15` a určuje jeden release `1.1.16`, úplný audit, STOP kritériá a rollback. |
| `WORK/2026-07-27_11-53_Inicializacia_analyza_a_plan_Kroku_12.md` | PRACOVNÝ | Záznam inicializácie, analýzy release mechanizmu a historických ZIP-ov, vytvorenia záväzného plánu Kroku 12 a potvrdenia, že `/codei`, workflow, verzia `1.1.15`, ZIP-y a produkcia zostali bez zmeny. |
...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 11 sú `SPLNENÉ`; Krok 12 je otvorený vlastným INI s `GATE=OPEN` a vykonáva sa podľa podrobného plánu `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md`. |
