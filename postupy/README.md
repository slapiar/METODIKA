...
|---|---|---|
| `WORK/INI/2026-07-27_15-07_INI_Krok_14_Tombstone_sweep_a_produkcny_cleanup.md` | PRACOVNÝ | Samostatná deväťbodová brána Kroku 14 je naplnená a uzavretá po vykonaní. Release `1.1.17` je nasadený, produkčný koncový stav je čistý, tri diagnostické flagy sú vypnuté a `diagnostics/database` už diagnostický obsah nezobrazuje. |
| `WORK/2026-07-27_15-16_Krok_14_Produkčný_cleanup_a_vypnutie_diagnostiky.md` | PRACOVNÝ | Produkčný záznam nulových run-store, temp a testovacích databázových zvyškov, vypnutia diagnostických flagov a následného fail-closed overenia. Krok 14 je `SPLNENÝ`; Krok 15 zatiaľ nie je otvorený. |
| `WORK/INI/2026-07-27_13-59_INI_Krok_13_Jeden_produkcny_run.md` | PRACOVNÝ | Krok 13 je uzavretý riadeným STOP po nasadení `1.1.16`: token a databázová diagnostika prešli, vizuálna regresia bola potvrdená a priamo opravená, no úplný súbežný produkčný výsledok nebol doložený. Brána je `OPEN_NAPLNENÁ_A_UZAVRETÁ_PO_RIADENOM_STOP`; ďalším povoleným úkonom je Krok 14 s vlastným INI a GATE. |
| `WORK/2026-07-27_15-00_Krok_13_Riadeny_STOP_po_produkcnom_nasadeni.md` | PRACOVNÝ | Pravdivý produkčný záznam nasadenia `1.1.16`, úspešnej základnej diagnostiky, príčiny CSS regresie, priamej produkčnej opravy, nedoloženého súbežného scenára a opravného release `1.1.17`. |
| `WORK/INI/2026-07-27_11-46_INI_Krok_12_Jeden_release_a_uplny_audit_balika.md` | PRACOVNÝ | Samostatná deväťbodová brána Kroku 12 je naplnená a uzavretá po vykonaní. Fázy 12.A–12.F sú `SPLNENÉ`; release `1.1.16` je úplne auditovaný, rollback `1.1.9` dostupný a produkcia bez zásahu. Jediným nasledujúcim povoleným úkonom je Krok 13 s vlastným INI a GATE. |
| `PLAN/2026-07-27_11-51_Plan_Kroku_12_release_a_audit_balika.md` | PRACOVNÝ — **ZÁVÄZNÝ PRE KROK 12** | Podrobný vykonávací plán Fáz 12.A–12.F je splnený. Konečný read-back commitu `cc0e5627...` potvrdil `/codei=4ec1d840...`, verziu `1.1.16`, ZIP blob `24b49768...`, SHA-256 `04742c8b...`, audit `PASS`, rollback a nulový zásah do produkcie. Krok 13 sa môže začať iba vlastným INI a bránou. |
| `WORK/2026-07-27_11-53_Inicializacia_analyza_a_plan_Kroku_12.md` | PRACOVNÝ | Úplný záznam inicializácie, analýzy a vykonania Fáz 12.A–12.F. Krok 12 je `SPLNENÉ`: jeden release `1.1.16`, manifest 813/813, nulové rozdiely a zakázané artefakty, dostupný rollback `1.1.9` a produkcia bez zásahu. |
...
| `PLAN/2026-07-26_06-07_Plan_dokoncenia_testovacej_sustavy.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Aktuálny rámcový plán Krokov 11 až 15. Kroky 1 až 14 sú `SPLNENÉ`; Krok 13 je uzavretý riadeným STOP a Krok 14 úspešne po nasadení `1.1.17`, nulovom produkčnom cleanupe, vypnutí troch flagov a fail-closed overení diagnostiky. Ďalším povoleným úkonom je Krok 15 s vlastným INI a GATE. |
