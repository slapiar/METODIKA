...
| `PLAN/2026-07-24_08-04_Plán_práce.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Opravená striktne lineárna verzia. Kroky 1 až 3 sú `SPLNENÉ`; jediným nasledujúcim povoleným krokom je Krok 4 — audit routovania, START vetiev a UI. |
...
| `2026-07-23_12-27_Copilot-checklist a testovacia matica.md` | PRACOVNÝ | Aktívny implementačný podklad. Kroky 2 a 3 záväzného plánu auditovali checklist 1–14 a maticu M01–M26; podrobné výsledky sú v príslušných záznamoch `WORK/`. |
