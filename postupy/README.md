...
| `Inicializácia práce.md` | POTVRDENÝ-NA-PRENESENIE | Sprísnená záväzná inicializačná brána. Výslovne rozlišuje `GATE=OPEN` predchádzajúceho kroku od `GATE=CLOSED` aktuálne vykonávaného kroku: zatvorená brána aktuálneho kroku neblokuje dokončenie jeho bodov 1 až 9, ale až analýzu, návrh, implementáciu a ďalšie úkony vyžadujúce otvorenú bránu. Cieľom prípadného prenesenia sú `README.md` a `CHECKLISTY/StartProjektu.md`. |
