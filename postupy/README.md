...
|---|---|---|
| `PLAN/2026-07-25_05-18_Plan_prace.md` | PRACOVNÝ — **ZÁVÄZNÝ** | Riadny plán práce na 2026-07-25. Kroky 1 až 10 sú `SPLNENÉ`; jediným nasledujúcim povoleným krokom je Krok 11, ktorý sa môže otvoriť iba vlastným novým INI záznamom a `GATE=OPEN`. |
| `WORK/INI/2026-07-25_08-14_INI_Dokoncenie_Kroku_10_po_STOP.md` | PRACOVNÝ | Dôkazový záznam Kroku 10: napravil chybné stotožnenie pomocného sandboxu s projektovým prostredím, prakticky overil PHP, Composer, MariaDB, migrácie, izoláciu, rollback a cleanup a otvoril bránu `GATE=OPEN`. |
