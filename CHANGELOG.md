...
- vytvorená technická politika [`TECHNICKE-NAVRHY/2026-07-22_POLITIKA-OPAKOVANEJ-REQUEST-REFERENCE.md`](TECHNICKE-NAVRHY/2026-07-22_POLITIKA-OPAKOVANEJ-REQUEST-REFERENCE.md) s rozhodnutím `IDEMPOTENT_REPLAY_BY_REQUEST_REFERENCE`: jedna konkrétna požiadavka vytvára najviac jeden `QUESTION_DERIVATION`, opakované doručenie rovnakého obsahu používa existujúci beh a odlišný obsah pod rovnakou referenciou je technický konflikt,
- vytvorená Validácia [`TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-POLITIKY-OPAKOVANEJ-REQUEST-REFERENCE.md`](TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-POLITIKY-OPAKOVANEJ-REQUEST-REFERENCE.md) s výsledkom `VALID`; všetkých pätnásť kritérií bolo splnených a pôvodné technické obmedzenie služby bolo odstránené,
