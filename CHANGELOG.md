...
- Validácia technického modelu uloženia je v [`TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-TECHNICKEHO-MODELU-ULOZENIA-ODVODZOVANIA-OTAZOK.md`](TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-TECHNICKEHO-MODELU-ULOZENIA-ODVODZOVANIA-OTAZOK.md) s výsledkom `VALID`,
- vytvorený [`TECHNICKE-NAVRHY/2026-07-22_DATABAZOVY-NAVRH-A-MIGRACNE-OBMEDZENIA-ODVODZOVANIA-OTAZOK.md`](TECHNICKE-NAVRHY/2026-07-22_DATABAZOVY-NAVRH-A-MIGRACNE-OBMEDZENIA-ODVODZOVANIA-OTAZOK.md) s fyzickým návrhom ôsmich tabuliek pre MySQLi/InnoDB, migračným poradím M1 až M8 a oddelením databázových a aplikačných invariantov,
- Validácia databázového návrhu je v [`TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-DATABAZOVEHO-NAVRHU-ODVODZOVANIA-OTAZOK.md`](TECHNICKE-NAVRHY/2026-07-22_VALIDACIA-DATABAZOVEHO-NAVRHU-ODVODZOVANIA-OTAZOK.md) s výsledkom `VALID`; pred vytvorením migrácií treba prakticky overiť konkrétny server, InnoDB, `utf8mb4`, `utf8mb4_bin` a `DATETIME(6)`,
